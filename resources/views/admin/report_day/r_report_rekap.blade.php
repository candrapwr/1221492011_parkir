...
<table width="889" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td><span class="style1">REKAP TRANSAKSI BULANAN </span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="113" valign="top"><table width="881" border="1" cellpadding="0" cellspacing="0">
      <tr>
        <td width="47" align="center" class="style2">NO</td>
        <td width="133" height="27" align="center" class="style2">TANGGAL</td>
        <td width="693" align="center"><span class="style2">NILAI TRANSAKSI  </span></td>
      </tr>
	  <?php
	  $i=0; 
	  $total = 0;
	  ...
	  <?php endforeach ?>
      <tr>
        <td height="30" colspan="2" align="right" class="style7"><strong>TOTAL</strong></td>
